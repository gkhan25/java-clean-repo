  ...
  stages {
    ...
    stage('dependency-check-scan') {
        steps{
            ...
            then
              aws sns publish --topic-arn "arn:aws:sns:us-east-1:163112212549:Jenkins" --message "see report following this link https://dsop-bucket-1234567890.s3.amazonaws.com/dependency-check-report.json"
